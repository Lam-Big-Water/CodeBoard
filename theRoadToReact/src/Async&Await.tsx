import { useReducer, useEffect, ChangeEvent, ReactNode, useRef, useCallback, useState } from "react";
...
const App = () => {
  const [searchTerm, setSearchTerm] = useStorageState("AsyncAwait", "Async");
